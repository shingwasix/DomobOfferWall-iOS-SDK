...
@interface ListWallViewController ()<DMOfferWallManagerDelegate> {
...
@implementation ListWallViewController
...
- (void)viewDidLoad
{
    ...
    [presentButton setTitle:@"显示列表积分墙" forState:UIControlStateNormal];
    [presentButton addTarget:self action:@selector(showListWall) forControlEvents:UIControlEventTouchUpInside];
